...
const ignoreKeyword = '@codesweep: ignore'
...
`
  ...
  if (options.disableReleaseNotes === false) {
    ...
    if (releaseNotesResponse === '') {
      ...
      let message = '### Summary by CodeSweep\n\n'
...
### Chat with <img src="https://avatars.githubusercontent.com/u/116506391?s=400&u=c4b137168dbcddf176c6da9d6890c4495e2a608b&v=4" alt="Image description" width="20" height="20">  CodeSweep Bot (\`@codesweep\`)
- Reply on review comments left by this bot to ask follow-up questions. A review comment is a comment on a diff or a file.
- Invite the bot into a review comment chain by tagging \`@codesweep\` in a reply.
...
- Add \`@codesweep: ignore\` anywhere in the PR description to pause further reviews from the bot.
